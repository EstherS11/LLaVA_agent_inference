...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/cache/LLaVA/checkpoints/llava-v1.5-7b-aoi-lora-v2")
    parser.add_argument("--model-base", type=str, default='/cache/LLaVA/pretrain/llava-v1.5-7b')
    parser.add_argument("--image-folder", type=str, default="/cache/zfr/07_AOI/zhuangbei_aoi/data/OK")
    parser.add_argument("--question-file", type=str, default="/cache/LLaVA/llava/eval/table/question_aoi_neg.jsonl")
    parser.add_argument("--answers-file", type=str, default="/cache/LLaVA/llava/eval/table/answer_aoi_neg.jsonl")
