...
def prepare_data():
    # 先 mox 再解压
    mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava/data/', '/home/ma-user/work/zhangfanrui/data/')

    os.system('unzip -nq /home/ma-user/work/zhangfanrui/data/image/pretrain_forgery.zip -d /home/ma-user/work/zhangfanrui/data/image/')
    print('data 准备完成')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--version', type=str, default='plain', help='the input data path')
    ...
    parser.add_argument('--save_steps', type=int, default=100, help='world size')
    parser.add_argument('--save_total_limit', type=int, default=1, help='world size')
    parser.add_argument('--learning_rate', type=float, default=1e-4, help='world size')
    ...
    parser.add_argument('--mm_projector_lr', type=float, default=1e-4, help='world size')
    ...
    # test commit
    mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava/code/LLaVA/','/home/ma-user/modelarts/user-job-dir/LLaVA')
    ...
    cmd = f"torchrun --nnodes={maenv.nnodes} --nproc_per_node={maenv.num_gpus} \
          --node_rank={maenv.node_rank} --master_addr={maenv.host} --master_port={maenv.port} \
